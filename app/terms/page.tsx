  ...
  return (
    <div className="min-h-screen py-12 px-4" dir="rtl">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold text-navy-700 mb-4">תנאי שימוש</h1>
        ...
        <div className="space-y-10 text-navy-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-navy-700 mb-3">אופי התכנים</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-navy-700 mb-3">הטבות ועסקים מומלצים</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-navy-700 mb-3">קניין רוחני</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-navy-700 mb-3">קישורים חיצוניים</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-navy-700 mb-3">הגבלת אחריות</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-navy-700 mb-3">שינויים בתנאים</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-navy-700 mb-3">יצירת קשר</h2>
            <p>
