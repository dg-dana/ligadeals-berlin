      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6" aria-label="טופס יצירת קשר" noValidate>
        ...
        <div>
          ...
          <textarea
            ...
            className={`w-full resize-none rounded-lg border-2 bg-white px-4 py-3 text-navy-800 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 dark:bg-navy-700 dark:text-white ${
              errors.message
                ? 'border-red-500 focus:border-red-600 focus:ring-red-500'
                : 'border-navy-100 focus:border-gold-500 focus:ring-gold-400 dark:border-navy-600'
            }`}
        ...
        <div className="flex gap-4">
          ...
          <a
            ...
            className="flex items-center gap-2 rounded-full bg-green-700 px-6 py-4 font-bold text-white shadow-lg transition-all hover:bg-green-800 hover:shadow-xl focus:outline-none focus-visible:ring-4 focus-visible:ring-gold-500 focus-visible:ring-offset-2"
          >
